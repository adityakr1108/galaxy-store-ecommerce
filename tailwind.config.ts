	...
	theme: {
		...
		extend: {
			colors: {
				...
				// New theme colors
				'theme-black': 'hsl(var(--theme-black))',
				'theme-white': 'hsl(var(--theme-white))',
				'theme-green': 'hsl(var(--theme-green))',
				'theme-green-light': 'hsl(var(--theme-green-light))',
				'theme-emerald': 'hsl(var(--theme-emerald))',
				'premium-gold': 'hsl(var(--premium-gold))',
				'premium-gold-light': 'hsl(var(--premium-gold-light))',
			},
			borderRadius: {
				lg: 'var(--radius)',
